...
function Footer() {
  return (
    <>
      <footer className="flex flex-col gap-8 place-items-center bg-black">
        <div className="bg-caramel h-1 w-24"></div>
        ...
        <div className="flex flex-col place-items-center gap-4 uppercase text-overline text-white font-medium">
        ...
        <div className="flex">
          <p className="text-center m-5 text-sub-title">
