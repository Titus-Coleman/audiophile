  ...
  return (
    <footer className=" bg-black">
      <div className="grid mobile:grid-cols-1 tablet:grid-cols-2 gap-10 pb-16 place-items-center mobile:mx-4 tablet:mx-8 desktop:mx-20">
        ...
        <div className="tablet:justify-self-start desktop:col-start-1">
          <p>Copyright 2023. All Rights Reserved</p>
        </div>
        <div className="mobile:col-span-1 tablet:justify-self-end desktop:col-start-2 desktop:row-start-2 ">
