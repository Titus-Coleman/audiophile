            ...
            <div className="navbar bg-black">
              ...
              <div className="flex-none relative">
                ...
                >
                  ...
                  <span className="bg-[#DC2626] flex absolute top-0 left-8 rounded-full text-white">
                    <div className="m-1">{totalQuantities}</div>
                  </span>
                </button>
                {showCart && <Cart />}
              </div>
            </div>
            <div className="h-[1px] w-100 bg-light-grey/30" />
          </div>
        </nav>
      </header>
      {/* <Cart /> */}
